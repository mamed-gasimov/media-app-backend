...
class DeleteNotification {
    notification(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            notification_sockets_1.socketIONotificationObject.emit('delete notification', notificationId);
            notification_queue_1.notificationQueue.addNotificationJob('deleteNotification', { key: notificationId });
            res.status(http_status_codes_1.default.OK).json({ message: 'Notification was deleted successfully' });
        });
    }
}
exports.deleteNotification = new DeleteNotification();
