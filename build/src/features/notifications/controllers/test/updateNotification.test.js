...
describe('Update notification', () => {
    ...
    it('should throw an error if notificationId is not available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        updateNotification_1.updateNotification.notification(req, res).catch((error) => {
    ...
    it('should send correct json response', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield updateNotification_1.updateNotification.notification(req, res);
        ...
        expect(notification_queue_1.notificationQueue.addNotificationJob).toHaveBeenCalledWith('updateNotification', {
