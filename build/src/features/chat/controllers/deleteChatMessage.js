...
exports.deleteChatMessage = exports.DeleteChatMessage = void 0;
...
class DeleteChatMessage {
    markMessageAsDeleted(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!helpers_1.Helpers.checkValidObjectId(receiverId) || !helpers_1.Helpers.checkValidObjectId(messageId)) {
                throw new errorHandler_1.BadRequestError('Invalid request.');
            }
            if (receiverId === `${req.currentUser.userId}`) {
                throw new errorHandler_1.BadRequestError('Invalid request.');
            }
            const updatedMessage = yield chatCache.markMessageAsDeleted(`${req.currentUser.userId}`, `${receiverId}`, `${messageId}`, type);
            ...
            chat_queue_1.chatQueue.addChatJob('markMessageAsDeletedInDb', {
...
__decorate([
    (0, joiValidation_decorator_1.joiValidation)(chat_1.deleteChatMessageSchema),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], DeleteChatMessage.prototype, "markMessageAsDeleted", null);
exports.DeleteChatMessage = DeleteChatMessage;
exports.deleteChatMessage = new DeleteChatMessage();
//# sourceMappingURL=deleteChatMessage.js.map