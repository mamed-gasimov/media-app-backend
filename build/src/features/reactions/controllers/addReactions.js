...
class AddReactions {
    reactions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield reactionCache.savePostReactionToCache(postId, reactionObject, type, previousReaction);
            ...
            reaction_queue_1.reactionQueue.addReactionJob('addReactionDataToDb', databaseReactionData);
            res.status(http_status_codes_1.default.OK).json({ message: 'Reaction added successfully.' });
        });
    }
}
__decorate([
    (0, joiValidation_decorator_1.joiValidation)(reactions_1.addReactionSchema),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], AddReactions.prototype, "reactions", null);
exports.addReactions = new AddReactions();
